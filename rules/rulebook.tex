...
\fancyfoot[C]{Rulebook v0.2.5 — \DTMtoday}
\fancyfoot[R]{\thepage}
...
\begin{enumerate}
\item Each player takes 4 shares of one company in the game and places them
in their player area on their unissued side (\ref{enu:unissued-shares}).
\item Each player takes the remaining 1 share of the starting company of
the player to their right and places it in their player area on its
issued side (\ref{enu:issued-shares}).
